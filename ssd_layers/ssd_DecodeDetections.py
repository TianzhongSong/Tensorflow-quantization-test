'''
A custom layer to decode the raw SSD prediction output. Corresponds to the
...
def DecodeDetections(y_pred,
    ...
    tf_confidence_thresh = tf.constant(confidence_thresh, dtype=tf.float32, name='confidence_thresh')
    tf_iou_threshold = tf.constant(iou_threshold, dtype=tf.float32, name='iou_threshold')
