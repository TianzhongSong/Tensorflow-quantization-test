"""
reference:https://github.com/pierluigiferrari/ssd_keras
"""
...
def get_weights_biases(weights, weight_name, bias_name, quant=True):
...
def ssd_512(inputs, weights,
            ...
            batch_size=1):
    '''
        Build a TensorFlow model with SSD512 architecture, see references.
    ...
    conv8_2 = conv_2d(conv8_1, w, b, s, strides=2, activation='relu', padding='VALID')
    ...
    conv9_2 = conv_2d(conv9_1, w, b, s, strides=2, activation='relu', padding='VALID')

    w, b, s = get_weights_biases(weights, 'conv10_1/kernel:0', 'conv10_1/bias:0')
    conv10_1 = conv_2d(conv9_2, w, b, s, activation='relu')
    conv10_1 = ZeroPadding2D(padding=((1, 1), (1, 1)))(conv10_1)
    w, b, s = get_weights_biases(weights, 'conv10_2/kernel:0', 'conv10_2/bias:0')
    conv10_2 = conv_2d(conv10_1, w, b, s, activation='relu', padding='VALID')
    ...
    w, b, s = get_weights_biases(weights, 'conv10_2_mbox_conf/kernel:0', 'conv10_2_mbox_conf/bias:0')
    conv10_2_mbox_conf = conv_2d(conv10_2, w, b, s)
    ...
    w, b, s = get_weights_biases(weights, 'conv10_2_mbox_loc/kernel:0', 'conv10_2_mbox_loc/bias:0')
    conv10_2_mbox_loc = conv_2d(conv10_2, w, b, s)
    ...
    conv8_2_mbox_priorbox = AnchorBoxes(conv8_2_mbox_loc, img_height, img_width, this_scale=scales[4],
                                        ...
                                        variances=variances, coords=coords, normalize_coords=normalize_coords,
                                        batch_size=batch_size)
    conv9_2_mbox_priorbox = AnchorBoxes(conv9_2_mbox_loc, img_height, img_width, this_scale=scales[5],
                                        next_scale=scales[6],
    ...
    conv10_2_mbox_priorbox = AnchorBoxes(conv10_2_mbox_loc, img_height, img_width, this_scale=scales[6],
                                         next_scale=scales[7],
