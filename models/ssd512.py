...
def ssd_512(inputs, weights,
    ...
    conv8_2 = conv_2d(conv8_1, w, b, strides=2, activation='relu', padding='VALID')
    ...
    conv9_2 = conv_2d(conv9_1, w, b, strides=2, activation='relu', padding='VALID')

    w, b = get_weights_biases(weights, 'conv10_1/kernel:0', 'conv10_1/bias:0')
    conv10_1 = conv_2d(conv9_2, w, b, activation='relu')
    conv10_1 = ZeroPadding2D(padding=((1, 1), (1, 1)))(conv10_1)
    w, b = get_weights_biases(weights, 'conv10_2/kernel:0', 'conv10_2/bias:0')
    conv10_2 = conv_2d(conv10_1, w, b, activation='relu', padding='VALID')
    ...
    w, b = get_weights_biases(weights, 'conv10_2_mbox_conf/kernel:0', 'conv10_2_mbox_conf/bias:0')
    conv10_2_mbox_conf = conv_2d(conv10_2, w, b)
    ...
    w, b = get_weights_biases(weights, 'conv10_2_mbox_loc/kernel:0', 'conv10_2_mbox_loc/bias:0')
    conv10_2_mbox_loc = conv_2d(conv10_2, w, b)
